"""
In this project, we will be classifying  different species of bird
...
train_dir = "bird_species_classification/train"

valid_dir = "bird_species_classification/valid"


# Walking through directory of our dataset
walk_through_dir("bird_species_classification")
...
checkpoint_path = "bird_species_classification_data_model_checkpoint/cp.ckpt"
...
base_model = applications.EfficientNetB3(include_top=False)
...
# Fit the model
bird_species_classification_history = model.fit(train_data, 
                                epochs=5,
                                ...
                                callbacks=[create_tensorboard_callback(dir_name="transfer_learing",
                                                                       experiment_name="bird_species_classification"),
                                           checkpoint_callback]
                                )
...
bird_species_classification_evaluation = model.evaluate(valid_data)

plot_loss_curves(bird_species_classification_history)
...
"""
filepaths = []
for filepath in test_data.list_files("bird_species_classification/test/*/*.jpg",
                                     shuffle=False):
